"""test `hydrogen_salt_storage.optimisation` functions.
...
def test_ref_power_curve():
    """Test `hydrogen_salt_storage.optimisation.ref_power_curve`"""
...
def test_weibull_probability_distribution():
    """Test `hydrogen_salt_storage.optimisation.weibull_probability_distribution`"""
...
def test_annual_energy_production():
    """Test `hydrogen_salt_storage.optimisation.annual_energy_production`"""
...
def test_annual_hydrogen_production():
    """Test `hydrogen_salt_storage.optimisation.annual_hydrogen_production`"""
    aep = 15e6
    e_elec = 0.07
    eta_conv = 0.9
    e_pcl = 0.004
...
def test_capex_pipeline():
    """Test `hydrogen_salt_storage.optimisation.capex_pipeline`"""
    e_cap = 500
    p_rate = 0.006
    capex = 2 * (
...
def test_lcot_pipeline():
    """Test `hydrogen_salt_storage.optimisation.lcot_pipeline`"""
    capex = 1000
