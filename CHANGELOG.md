...
- calculate hydrogen density using a defined pressure (pipeline pressure of 65-100 bar) and temperature (seabed temperature of 10 °C)
...
- to-do: update the ratio of the electrolyser capacity to the offshore wind farm capacity
